...
class BaselineNetwork(nn.Module):
    ...
    def __init__(self, env, config):
        ...
        action_dim = self.env.action_space.n if discrete else self.env.action_space.shape[0]
    ...
    def calculate_advantage(self, returns, observations):
        ...
        # print
        baseline_result = self(observations)
        advantages = returns - baseline_result.detach().numpy()
        #######################################################
        #########          END YOUR CODE.          ############
        return advantages
    ...
    def update_baseline(self, returns, observations):
        ...
        loss = nn.functional.mse_loss(output, returns)
        loss.backward()
        self.optimizer.step()
        #######################################################
        #########          END YOUR CODE.          ############
